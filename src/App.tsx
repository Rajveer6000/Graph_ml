...
function App() {
  ...
  return (
    <>
      <div className="p-10 rounded-3xl bg-[#86ffb2]">
        <div>
          <div className=" p-5 rounded-3xl my-5 mb-10 border-2 border-[#4fff8f] w-full flex  justify-between bg-white">
            <div className="flex  rounded-xl p-5">
              <label className="px-4 py-2 font-bold my-auto">Email : </label>
              <input
                type="email"
                value={email}
                onChange={handleEmailChange}
                className=" text-[#267e46] px-4 py-2 rounded-xl font-bold border-2 border-[#267e46] w-80"
              />
            </div>
            <div className=" my-auto ">
              <button className="bg-[#86ffb2] text-black p-4 w-40 rounded-xl" onClick={getdata }>
                Get Data
              </button>
            </div>
          </div>
